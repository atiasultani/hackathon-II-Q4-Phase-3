...
## Core Skills
- **Parent Communication**: Ability to receive instructions and report status to the main-agent
...
The doc-sub-agent sub-agent can:
- Receive and execute delegated tasks from main-agent
- Operate autonomously within defined parameters
- Communicate status and results to the parent

## Dependencies
- Relies on main-agent for task assignments and coordination
